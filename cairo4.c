...
int main(int argc, char *argv[])
{
	...
	gtk_window_set_title( GTK_WINDOW(window), "cairo 4");
	g_signal_connect( window, "destroy", G_CALLBACK( close_window), NULL);		// close event
    ...
    g_timeout_add(1000, (GSourceFunc)timer_func, NULL);			// timer event
